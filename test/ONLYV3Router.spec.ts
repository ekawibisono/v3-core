...
describe('ONLYV3Pool', () => {
  ...
  let pool0: MockTimeONLYV3Pool
  let pool1: MockTimeONLYV3Pool
  ...
  let swapTargetCallee: TestONLYV3Callee
  let swapTargetRouter: TestONLYV3Router
  ...
  beforeEach('deploy first fixture', async () => {
    ...
    ): Promise<[MockTimeONLYV3Pool, any]> => {
